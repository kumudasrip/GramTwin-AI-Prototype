    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-earth-primary border-t-transparent rounded-full animate-spin mx-auto mb-4" />
  ...
  return (
    <div className="space-y-6">
      ...
      <motion.div
        ...
        className="mb-8"
      >
        <h1 className="text-4xl font-bold text-earth-primary mb-2 flex items-center gap-3">
          <MessageSquare className="w-10 h-10" />
          {t('citizenQueries.title')}
        </h1>
        <p className="text-gray-600">{t('citizenQueries.description')}</p>
      </motion.div>
